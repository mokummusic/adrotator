jQuery(document).ready(function($) {
    ...
    $.post(mAdRotator.ajaxurl, data, function(response) {
    	...
    	$.each($('.madrotator'), function(i) {
    		...
    		if (adHtml[i].indexOf('class="ad-text"') > -1) {
				...
				$(this).html('<div class="adrotator-text" id="adrotator-text-'+i+'"><div class="ad-text"><h2><a rel="nofollow" href="'+href+'">'+textlines[0].replace(/\\/g, '')+'</a></h2><p>'+textlines[1].replace(/\\/g, '')+'</p></div><a rel="nofollow" href="'+href+'"><div class="ad-textbutton">></div></a></div>');
	...
	function resizeTextAd(that, href, alt, src) {
		...
		if ($(that).width() >= 550) {
			if (src.length > 0) {
				$(that).find('.adrotator-text').html('<div class="ad-text with-thumb"><h2><a rel="nofollow" href="'+href+'">'+textlines[0].replace(/\\/g, '')+'</a></h2><p>'+textlines[1].replace(/\\/g, '')+'</p></div><a rel="nofollow" href="'+href+'"><div class="ad-textbutton ad-img-button" style="background-image:url('+src+');">></div></a>');
			} else {
				$(that).find('.adrotator-text').html('<div class="ad-text"><h2><a rel="nofollow" href="'+href+'">'+textlines[0].replace(/\\/g, '')+'</a></h2><p>'+textlines[1].replace(/\\/g, '')+'</p></div><a rel="nofollow" href="'+href+'"><div class="ad-textbutton">></div></a>');
			}
			...
			if (src.length > 0) {
				$(that).find('.adrotator-text').html('<div class="ad-text"><h3><a rel="nofollow" href="'+href+'">'+textlines[0].replace(/\\/g, '')+'</a></h3><p>'+textlines[1].replace(/\\/g, '')+'</p></div><a rel="nofollow" href="'+href+'"><div class="ad-textbutton ad-img-button" style="background-image:url('+src+');">></div></a>');
			} else {
				$(that).find('.adrotator-text').html('<div class="ad-text"><h3><a rel="nofollow" href="'+href+'">'+textlines[0].replace(/\\/g, '')+'</a></h3><p>'+textlines[1].replace(/\\/g, '')+'</p></div><a rel="nofollow" href="'+href+'"><div class="ad-textbutton">></div></a>');
			}
